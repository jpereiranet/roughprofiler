...
class Ui_RoughProfiler2(object):
    def setupUi(self, RoughProfiler2):
        ...
        self.ReferenceNameValue.setGeometry(QtCore.QRect(100, 590, 401, 16))
        font = QtGui.QFont()
        ...
        self.tabWidget.setGeometry(QtCore.QRect(600, 140, 231, 421))
...
"} ")
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.DcamprofICC.setFont(font)
        self.DcamprofICC.setStyleSheet("color: rgb(155, 155, 155);")
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.DcamprofDCP.setFont(font)
        self.DcamprofDCP.setStyleSheet("color: rgb(155, 155, 155);")
        ...
        self.radioButton.setStyleSheet("color: rgb(155, 155, 155);")
        ...
        self.radioButton_2.setStyleSheet("color: rgb(155, 155, 155);")
        self.radioButton_2.setObjectName("radioButton_2")
        self.tabWidget_2 = QtWidgets.QTabWidget(RoughProfiler2)
        self.tabWidget_2.setGeometry(QtCore.QRect(10, 140, 581, 421))
...
"")
        ...
        self.InstallProfile_2 = QtWidgets.QToolButton(RoughProfiler2)
        self.InstallProfile_2.setGeometry(QtCore.QRect(760, 570, 71, 61))
        self.InstallProfile_2.setObjectName("InstallProfile_2")
        self.FileNameValue = QtWidgets.QLabel(RoughProfiler2)
        self.FileNameValue.setGeometry(QtCore.QRect(100, 570, 401, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, RoughProfiler2):
        ...
        self.InstallProfile_2.setToolTip(_translate("RoughProfiler2", "Create Proof Image"))
        self.InstallProfile_2.setText(_translate("RoughProfiler2", "..."))
