...
"}")
    ...
    def retranslateUi(self, RoughProfiler2):
        ...
        self.label_10.setText(_translate("RoughProfiler2", "Exposure Offset"))
        ...
        self.confLabelArgyll.setText(_translate("RoughProfiler2", "ArgyllCMS Executables"))
        self.confLabelDcamprof.setText(_translate("RoughProfiler2", "Dcamprof Executables"))
