...
"} ")
        ...
        self.DcamprofICCResLUT = QtWidgets.QComboBox(self.tabDcamICC)
        self.DcamprofICCResLUT.setGeometry(QtCore.QRect(10, 180, 191, 26))
        self.DcamprofICCResLUT.setStyleSheet("color: rgb(145, 145, 145);")
        self.DcamprofICCResLUT.setObjectName("DcamprofICCResLUT")
        self.label_11 = QtWidgets.QLabel(self.tabDcamICC)
        self.label_11.setGeometry(QtCore.QRect(10, 160, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_11.setFont(font)
        self.label_11.setStyleSheet("color: rgb(155, 155, 155);")
        ...
        self.DcamprofToneDCP.setGeometry(QtCore.QRect(10, 40, 191, 26))
        ...
        self.DcamprofTOPeratoDCP.setGeometry(QtCore.QRect(10, 90, 191, 26))
        ...
        self.DcamExposureSlider.setGeometry(QtCore.QRect(10, 150, 141, 22))
        ...
        self.TabDcamCom = QtWidgets.QWidget()
        self.TabDcamCom.setObjectName("TabDcamCom")
        self.DcamprofIlluminant = QtWidgets.QComboBox(self.TabDcamCom)
        self.DcamprofIlluminant.setGeometry(QtCore.QRect(10, 40, 191, 26))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.IlluminantLabel = QtWidgets.QLabel(self.TabDcamCom)
        self.IlluminantLabel.setGeometry(QtCore.QRect(10, 20, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.GlareCheckBox = QtWidgets.QCheckBox(self.TabDcamCom)
        self.GlareCheckBox.setGeometry(QtCore.QRect(10, 80, 151, 20))
        font = QtGui.QFont()
        ...
        self.YLimitBox = QtWidgets.QLineEdit(self.TabDcamCom)
        self.YLimitBox.setGeometry(QtCore.QRect(10, 110, 51, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.YLimitBox.setFont(font)
        self.YLimitBox.setStyleSheet("color: rgb(145, 145, 145);")
        self.YLimitBox.setObjectName("YLimitBox")
        self.IlluminantLabel_2 = QtWidgets.QLabel(self.TabDcamCom)
        self.IlluminantLabel_2.setGeometry(QtCore.QRect(70, 110, 61, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tabsDcamprof.addTab(self.TabDcamCom, "")
...
"")
        ...
        self.tabsDcamprof.setCurrentIndex(2)
    ...
    def retranslateUi(self, RoughProfiler2):
        ...
        self.label_11.setText(_translate("RoughProfiler2", "LUT Resolution"))
        ...
        self.tabsDcamprof.setTabText(self.tabsDcamprof.indexOf(self.TabDcamCom), _translate("RoughProfiler2", "Common"))
